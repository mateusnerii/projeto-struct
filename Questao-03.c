...
char endereço[MILUSUARIOS][CARACTERESEND];
...
void adicionarusuario() {
    ...
    fgets(endereço[numCadastros], sizeof(endereço[numCadastros]), stdin);
    endereço[numCadastros][strcspn(endereço[numCadastros], "\n")] = '\0';
...
void editar() {
    ...
    switch (fieldChoice) {
        ...
        case 4: {
            ...
            getchar();
            fgets(endereço[userIndex], sizeof(endereço[userIndex]), stdin);
            endereço[userIndex][strcspn(endereço[userIndex], "\n")] = '\0';
...
void deletar() {
    ...
    for (int i = userIndex; i < numCadastros - 1; i++) {
        ...
        strcpy(endereço[i], endereço[i + 1]);
